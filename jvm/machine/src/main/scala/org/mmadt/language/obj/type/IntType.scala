...
trait IntType extends Int
  ...
  override def gt(other:Type[Int]):BoolType = this.compose(tbool(),GtOp(other))
  override def gt(other:Value[Int]):BoolType = this.compose(tbool(),GtOp(other))
  override def eqs(other:Type[Int]):BoolType = this.compose(tbool(),EqsOp(other))
  override def eqs(other:Value[Int]):BoolType = this.compose(tbool(),EqsOp(other))
