...
package object theory {
  ...
  trait TypeCommon[T <: Type[T]] extends TypeIs[T] with TypeTo[T] with TypeFrom[T] with TypeChoose[T] //
  ...
  trait ValueCommon[V <: Value[V], T <: Type[T]] extends ValueIs[V, T] with ValueTo[V, T] with ValueFrom[V, T] with ValueChoose[V]
