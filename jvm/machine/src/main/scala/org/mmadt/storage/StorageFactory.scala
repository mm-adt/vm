...
object StorageFactory {
  ...
  def trec[A <: Obj, B <: Obj](g: (A, B), gs: (A, B)*)(implicit f: StorageFactory): RecType[A, B] = f.trec(g, gs: _*)
  /////////VALUES/////////
  ...
  def vrec[A <: Value[Obj], B <: Value[Obj]](g: collection.Map[A, B])(implicit f: StorageFactory): RecValue[A, B] = f.vrec(Tokens.rec, g, qOne)
  def vrec[A <: Value[Obj], B <: Value[Obj]](g: (A, B), gs: (A, B)*)(implicit f: StorageFactory): RecValue[A, B] = f.vrec(g, gs: _*)
  ...
  def vrec[A <: Value[Obj], B <: Value[Obj]](name: String = Tokens.rec, g: collection.Map[A, B], q: IntQ = qOne, via: ViaTuple = base)(implicit f: StorageFactory): RecValue[A, B] = f.vrec(name, g, q, via)
  ...
  implicit val mmstoreFactory: StorageFactory = new StorageFactory {
    //override def :|[A <: Obj](values: A*): Poly[A] = new OPoly[A](g = values.toList)
    /////////TYPES/////////
