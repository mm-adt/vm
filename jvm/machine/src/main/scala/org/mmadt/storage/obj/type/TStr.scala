...
import org.mmadt.language.obj.{Inst, OType, Obj, Str, TQ}
import org.mmadt.storage.obj._

/**
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 */
class TStr(name:String,insts:List[(OType,Inst)],quantifier:TQ) extends AbstractTObj[Str](name,insts,quantifier) with StrType  {
