...
object TestSetUtil {
  ...
  def testing(lhs:Obj, rhs:Obj, result:Obj, query:String, queries:String*):(Obj, Obj, Result, List[String], List[(Model, String)]) = (lhs, rhs, Left(result), query +: queries.toList, Nil)
