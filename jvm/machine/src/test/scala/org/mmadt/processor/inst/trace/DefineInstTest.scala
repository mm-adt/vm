  ...
  test("[define] value, type, strm, anon combinations") {
    val starts: TableFor2[Obj, Obj] =
      new TableFor2[Obj, Obj](("query", "result"),
        ...
        ((int(1) `,` (int(1) `,` 1)).define("abc", __.-<(__.is(__.eqs(1)) | (int(1) `,` __.named("abc"))) >-).a(__.named("abc")), btrue),
        ((int(1) `,` (int(1) `,` 2)).define("abc", __.-<(__.is(__.eqs(1)) | (int(1) `,` __.named("abc"))) >-).a(__.named("abc")), bfalse),
        ((int(1) `,` (int(2) `,` 1)).define("abc", __.-<(__.is(__.eqs(1)) | (int(1) `,` __.named("abc"))) >-).a(__.named("abc")), bfalse),
        // ((int(1) `,` (int(1) `,` 2)).define("abc", __.-<(__.is(__.a(int)) | (int(1) `,` __.named("abc"))) >-).a(__.named("abc")), btrue), // TODO: Because of [a] and TraceInstructiob
        // ((int(1) `,` (int(1) `,` 2)).define("abc", __.`[`(__.is(__.a(int)) | (int `,` __.named("abc"))) `]`).a(__.named("abc")), btrue),
        // ((int(1) `,` (int(1) `,` (int(2) `,` 3))).define("abc", __.`[`(__.is(__.a(int)) | (int `,` __.named("abc"))) `]`).a(__.named("abc")), btrue),
        ((int(1) `,` (int(1) `,` (int(2) `,` 3))).define("abc", __.`[`(__.is(__.lt(2)) | (int `,` __.named("abc"))) `]`).a(__.named("abc")), bfalse),
        ((int(1) `,` (int(1) `,` (int(2) `,` 3))).define("abc", __.`[`(__.is(__.lt(5)) | (int `,` __.named("abc"))) `]`).a(__.named("abc")), btrue)
      )
