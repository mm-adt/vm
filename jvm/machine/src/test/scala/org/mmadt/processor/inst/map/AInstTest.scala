...
class AInstTest extends BaseInstTest(
  testSet("[a] table test",
    ...
    testing(20, a(int.is(gt(10))), true),
    testing(20, a(int.is(int.lt(0))), false),
    testing(20, a(int.is(int.gt(0))), true),
    testing(20, a(int.mult(int.neg).is(int.lt(0))), true),
    testing(20, a(int.is(lt(0))), false),
    testing(20, a(int.is(gt(0))), true),
    testing(1, a(int.is(gt(0))), true),
    testing(1, a(int.is(lt(1))), false),
    ...
    testing(20, a(real), false),
    testing(20, a(str), false),
    testing(20, a(rec), false),
    testing(int, a(20), int.a(20)),
    testing(int, a(int), int.a(int)),
