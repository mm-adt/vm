...
class CombineInstTest extends BaseInstTest(
  testSet("[combine] ,-lst", List(NONE, MM, MMX),
    IGNORING("eval-3", "eval-4", "eval-5")(1, -<(plus(1) `,` plus(2)).combine(mult(4) `,` plus(7)), 8 `,` 10, "1-<(+1,+2)=(*4,+7)"),
    IGNORING("eval-3", "eval-4", "eval-5")(lst(int(1)), >-.-<(plus(1) `,` plus(2)).combine(mult(4) `,` plus(7)), 8 `,` 10, "(1)>--<(+1,+2)=(*4,+7)"),
