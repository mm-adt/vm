...
class __Test extends FunSuite {
  ...
  test("__ quantifiers") {
    ...
    assertResult(int(1))(int(1) =>> __.q(10))
    ...
    assertResult(int(20).q(2000))(int(1).q(2) =>> __.plus(1).q(10).mult(10).q(100))
    assertResult(int(21).q(2000))(int(1).q(2) =>> __.plus(1).q(10).mult(10).q(100).plus(1))
    assertResult(int(42).q(2000))(int(1).q(2) =>> __.plus(1).q(10).mult(10).q(100).plus(1).plus(__.id.q(1000)))
    assertResult(int(45).q(2000))(int(1).q(2) =>> __.plus(1).q(10).mult(10).q(100).plus(1).plus(__.id.q(1000)).plus(3))
  }
