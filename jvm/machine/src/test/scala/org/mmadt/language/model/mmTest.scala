...
class mmTest extends BaseInstTest(
  testSet("mm model table test", MM,
    comment("int"),
    testing(int, int.plus(0).plus(plus(0).plus(5)).plus(0), int.plus(int.plus(5)), "int => int+0[plus,+0+5]+0"),
    ...
    testing(int, int.one.q(5), 1.q(5), "int => int[one]{5}"),
    // testing(int.q(5), one, 1.q(5), "int{5} => [one]"),
    // testing(int.q(5), int.q(5).one, 1.q(5), "int{5} => int{5}[one]"),
    testing(int, int.zero.q(40), 0.q(40), "int => int[zero]{40}"),
    testing(int.q(10), int.q(10).mult(zero).q(2).plus(10).q(3), 10.q(60), "int{10} => int{10}[mult,[zero]]{2}[plus,10]{3}"),
    testing(int, int.mult(one).plus(10), int.plus(10), "int => int[mult,[one]][plus,10]"),
    comment("str"),
