...
class digraphTest extends BaseInstTest(
  testSet("digraph model table test", DIGRAPH,
    ...
    IGNORING("eval-[3-5]")('vertex(str("id") -> 'nat(65)), 'vertex `=>` 'nat `=>` int, 65,
      "vertex:('id'->nat:65) => vertex => nat => int",
      "vertex:('id'->nat:65) => nat => int => vertex => nat => int",
      "vertex:('id'->nat:65) => nat => vertex => int",
      "vertex:('id'->nat:65) => nat => int",
      // "vertex:('id'->nat:65) => int",
      "vertex:('id'->nat:65) => vertex => int"),
