...
NOTE: The mm-ADT stream ring is more accurately known as a *ringoid*. A ringoid is a ring without operator closure. That is, some `obj` compositions are undefined such as `5 + 'a'`. Given that closure is more accurately understood to be determined by the instruction set architecture, the term *ring* will be used.
