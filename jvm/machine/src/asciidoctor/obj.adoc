...
A `poly` composed of `obj` values is a collection data structure. Given that there are two kinds of `poly` (`lst` and `rec`) and each having 3 forms (`,`,`;`,`|`), mm-ADT offers 6 different sorts of collections.
