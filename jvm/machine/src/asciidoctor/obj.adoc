...
[.small]
[cols="1,1,3,3,3",width=60,float=right]
|===
...
[cols="2,3,3,9"]
|===
| poly | algebra | use | example

| `,-lst` | https://en.wikipedia.org/wiki/Abelian_group[abelian group] | weighted multi-set
a|
[exec]
----
('a','a','b','a','c','b')
...
----
{blank}
| `;-lst` | https://en.wikipedia.org/wiki/Monoid[monoid] | standard list
a|
[exec]
----
('a';'a';'b';'a';'c';'b')
