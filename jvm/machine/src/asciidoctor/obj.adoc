...
a:b
\]
where, for the first, \$a\$ is _generated_ by \$b\$ and for the second, \$a\$ is _structured_ as \$b\$ and, when considering no extending instructions to the \$a<=b\$ form, \$a<=b \cong a:b\$ such that \$b\$ is _named_ \$a\$.
