...
(8;26;2020) => date ## LanguageException
(8;26)      => date ## LanguageException
----
...
----
:[model,pg_1]                                //<1>
1 => vertex<=int-<('id'->_)                  ## vertex:('id'->1)  //<2>
1 => vertex<=int-<('id'->_,'age'->+28)       ## vertex:('id'->1)  //<3>
1 => vertex<=int-<('ID'->_)                  ## LanguageException //<4>
----
...
5 => vertex                                     ## vertex:('id'->5)                    //<2>
(5;6) => (vertex;vertex)                        ## (vertex:('id'->5);vertex:('id'->6)) //<3>
----
