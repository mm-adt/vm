...
Finally, the most compact sugar forms of the running "split-merge" examples is presented below. Given the verbosity of branching expressions, all subsequent examples will typically leverage as many sugar constructs as possible to ensure readability.
