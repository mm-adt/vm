...
image::obj-type-value-q.png[float=left,width=340]
...
[.center]
[cols="1,3,1,1,9",width=85]
|===
| name | description | sugar | unsugared | mmlang example
...
dependent terms +
\[A^{_A A} = A \]
| image:semi-delta-nabla.png[link=images/language/semi-delta-nabla.png]
