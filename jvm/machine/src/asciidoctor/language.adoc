...
[cols="1,3,5"]
|===
^| equation ^| diagram | mmlang

| \[ (a+b+b)(a+b+b+b) \]       | image:binomial-1.svg[]
a|
[exec]
----
['a','b','b']
...
----
{blank}
| \[ (a+2b)(a+4b) \]           | image:binomial-2.svg[]
a|
[exec]
----
['a','b'{2}]
...
----
{blank}
| \[ a^2 + 2ba + 4ab + 8b^2 \] | image:binomial-3.svg[]
a|
[exec]
----
['aa','ba'{2},'ab'{4},'bb'{8}]
...
----
{blank}
| \[ a^2 + 6ab + 8b^2       \] | image:binomial-4.svg[]
a|
[exec]
----
['aa','ab'{6},'bb'{8}]
