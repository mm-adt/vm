...
================================================================
The `mmlang` examples to in the table to follow are generated by a language that acts on the `inst` monoid. The *type ringoid* has an embedding in the `inst` monoid. Another embedding exists in the logic of the implementing processor. Various modern processor architectures naturally respect the type ringoid axioms.
