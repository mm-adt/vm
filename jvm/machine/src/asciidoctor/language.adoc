...
A https://en.wikipedia.org/wiki/Cartesian_closed_category#Bicartesian_closed_categories[bicartesian closed category] supports https://en.wikipedia.org/wiki/Product_(category_theory)[products], https://en.wikipedia.org/wiki/Coproduct[coproducts], a product unit, a coproduct unit, https://en.wikipedia.org/wiki/Exponential_object[exponents], and products distribute over coproducts. These features are captured by the following axioms below.
