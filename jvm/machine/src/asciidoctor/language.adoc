...
Products https://en.wikipedia.org/wiki/Product_(category_theory)#Distributivity[distribute] over co-products. Therefore, mm-ADT has two sorts of `objs`: _quantified types_ and a _quantified values_.
