...
There are two distinct kinds of mm-ADT `objs`: _quantified_ type objects and _quantified_ value objects.
The products of the `obj` coproduct are called *type* and *value*.
