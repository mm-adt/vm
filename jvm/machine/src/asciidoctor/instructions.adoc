...
The mm-ADT VM https://en.wikipedia.org/wiki/Instruction_set_architecture[instruction set architecture] is itemized below, where the instructions are ordered by their instruction classification and within a classification, alphabetically ordered.
