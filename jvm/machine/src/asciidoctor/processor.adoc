...
The resultant polynomial ring composition is expressed in `mmlang` below.
...
The above representation take the form of a free monoid ring where elements of the free monoid are linearly combined by in a free abelian group. This takes the form of a matrix where the rows are monoid chains.
...
\[
\begin{bmatrix}\tt{int}; & +2; & \tt{[is>0]} \end{bmatrix} ; \begin{bmatrix}
...
\[
\begin{bmatrix}\tt{int}; & +2; & \tt{[is>0]} \end{bmatrix} ; \begin{bmatrix}
*5; & \_ , \\ *{-6}; & \_ , \\ *10; & +7 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix}
\]
...
*5; & \_ , \\ *{-6}; & \_ , \\ *10; & +7 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix} \\ \begin{bmatrix}5; & +2; & \tt{[is>0]} \end{bmatrix} ; & \begin{bmatrix}
*5; & \_ , \\ *{-6}; & \_ , \\ *10; & +7 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix} \\ 7 ; & \begin{bmatrix}
*5; & \_ , \\ *{-6}; & \_ , \\ *10; & +7 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix} \\ & \begin{bmatrix}
35; & \_ , \\ -42; & \_ , \\ 70; & +7 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix} \\ & \begin{bmatrix}
35, \\ -42, \\ 77 \\ \end{bmatrix} ; \begin{bmatrix} <44 \end{bmatrix} \\ & \begin{bmatrix}
