 ...
 */
public final class LtMap<S extends WithOrder<S>> extends AbstractFunction implements MapFunction<S, Bool> {

    private LtMap(final Q quantifier, final String label, final Argument<S, S> argument) {
